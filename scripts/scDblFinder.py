import scripts.basic as basic
import anndata
from scripts.rTools import r_set_seed
from scripts.rTools import ad2so
from scripts.rTools import r2py
import rpy2
...
def run_ScDblFinder(
    ...
    logger.info("End to intergrate result with adata")
